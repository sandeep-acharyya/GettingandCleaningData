...
# A tibble: 180 x 88
# Groups:   subject [30]
   subject activity TimeBodyAcceler~ TimeBodyAcceler~ TimeBodyAcceler~ TimeGravityAcce~ TimeGravityAcce~ TimeGravityAcce~ TimeBodyAcceler~ TimeBodyAcceler~
 ...
 5       1 WALKING~            0.289         -0.00992          -0.108             0.932           -0.267          -0.0621           0.0542         0.0297  
 6       1 WALKING~            0.255         -0.0240           -0.0973            0.893           -0.362          -0.0754           0.101          0.0195  
